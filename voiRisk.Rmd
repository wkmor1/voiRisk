...
To overcome the non-equivalence of EUWPI and EVWPI due to their non-linear relationship, we must reformulate them in a slightly different way. Where before we discussed EVPI as the magnitude of performance increase moving from uncertainty to certainty, to express EUPI on the same scale we use the method outline by @Eeckhoudt2000 and which show here.
